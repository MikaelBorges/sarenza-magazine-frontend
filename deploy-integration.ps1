...
helm upgrade -i --set image.tag=$version --wait magazine ./helm/sarenza-digitalexperience-magazine --tiller-namespace digitalexperience-integration-tiller --namespace digitalexperience-integration
