  ...
  return (
    <style>
      {`
        ...
        #MainFooter .cta-faq a.title:after {
          content: '';
          width: 5px;
          height: 5px;
        ...
        #MainFooter .contact-Sc {
          margin: 32px 10px 0;
          padding: 0;
          display: flex;
          flex-flow: nowrap;
        }
        #MainFooter .contact-Sc .contact-phone {
          width: 50%;
        }
        ...
        #MainFooter .contact-Sc .contact-phone > span {
          font-family: robotoc, 'Arial Narrow', sans-serif;
          font-weight: 700;
          font-size: 16px;
          color: #ff2157;
        ...
        #MainFooter .contact-Sc .contact-phone .title {
          color: #1d1d1b;
          font-size: 14px;
        }
        #MainFooter .contact-Sc .contact-phone .title + span {
          font-size: 14px;
        }
        #MainFooter .contact-Sc .contact-mail {
          width: 50%;
        }
        ...
        #MainFooter .contact-Sc .contact-mail > a {
          font-family: robotoc, 'Arial Narrow', sans-serif;
          font-size: 14px;
          font-weight: 700;
          color: #ff2157;
        ...
        #MainFooter .subscribe-newsletter {
          border-top: 1px solid #f2f2f2;
          padding: 32px;
        }
        ...
        #MainFooter .subscribe-newsletter .legal-message a.remote-popin,
        #MainFooter .subscribe-newsletter > p {
          font-family: robotoc, 'Arial Narrow', sans-serif;
        }
        #MainFooter .subscribe-newsletter > p {
          font-weight: 700;
        ...
        #MainFooter .subscribe-newsletter .button:after {
          right: 24px;
        }
        #MainFooter .subscribe-newsletter .button + .button {
          margin-left: 3px;
        }
        #MainFooter .subscribe-newsletter .legal-message {
          width: 100%;
        ...
        #MainFooter .subscribe-newsletter .success {
          text-align: left;
          font-family: robotoc, 'Arial Narrow', sans-serif;
          font-size: 14px;
          margin: 0 0 16px;
        ...
        #MainFooter .mobile-app .title-level2 {
          text-align: left;
          text-transform: uppercase;
        }
        #MainFooter .mobile-app > p {
          font-family: robotoc, 'Arial Narrow', sans-serif;
          font-size: 14px;
          color: #737373;
          line-height: 20px;
        ...
        #MainFooter .mobile-app .apple {
          display: block;
          overflow: hidden;
          width: 135px;
          height: 40px;
        }
        #MainFooter .mobile-app .android {
          margin: 0 0 0 -10px;
          width: 155px;
          height: 54px;
          overflow: hidden;
        ...
        #MainFooter .mobile-app.no-background .title-level2,
        #MainFooter .reviews .rating > span,
        #MainFooter .reviews .title-level2 {
          text-align: center;
        }
        #MainFooter .mobile-app.no-background {
          background: 0 0;
        }
        #MainFooter .mobile-app.no-background > p {
          text-align: center;
          width: 100%;
        }
        #MainFooter .reviews {
        ...
        #MainFooter .reviews .rating > span.average,
        #MainFooter .reviews .rating > span.best {
          font-family: robotoc, 'Arial Narrow', sans-serif;
          display: inline;
          font-size: 40px;
          color: #1d1d1b;
        ...
        #MainFooter .reviews .rating .votes,
        #MainFooter nav.footer-nav .folder {
          color: #000;
          font-size: 14px;
          font-family: robotoc, 'Arial Narrow', sans-serif;
        }
        #MainFooter .reviews .rating > span + span {
          margin-top: 3px;
        }
        #MainFooter .reviews .rating .votes {
          margin-top: 3px;
        ...
        #MainFooter .reviews .rating .votes > span {
          display: inline-block;
        }
        ...
        #MainFooter nav.footer-nav .folder:after {
          content: '';
          width: 4px;
          height: 4px;
        ...
        #MainFooter nav.footer-nav .folder.open:after {
        ...
        #MainFooter nav.footer-nav .folder.flags:before {
          margin-right: 12px;
          vertical-align: -2px;
        }
        #MainFooter nav.footer-nav .fold {
          margin: 0;
          padding: 0 20px 25px;
        }
        #MainFooter nav.footer-nav .fold > li {
          font-family: robotoc, 'Arial Narrow', sans-serif;
          font-size: 14px;
          line-height: 34px;
          list-style: none;
        ...
        #MainFooter nav.footer-nav .fold > li > a,
        #MainFooter nav.footer-nav .fold > li > span {
          color: #737373;
        }
        #MainFooter nav.footer-nav .fold.sprite {
          display: flex;
          flex-flow: row wrap;
          margin: 0;
          padding: 0 20px 20px 0;
        }
        #MainFooter nav.footer-nav .fold.sprite > li {
        ...
        #MainFooter nav.footer-nav .fold.sprite > li a,
        #MainFooter nav.footer-nav .fold.sprite > li span {
          transform: scale(0.8);
        }
        #MainFooter nav.footer-nav .fold.sprite-flags {
          margin: 0;
          padding: 10px 10px 25px;
        }
        #MainFooter nav.footer-nav .fold.sprite-flags > li a:before {
          margin-right: 13px;
        }
        #MainFooter nav.footer-nav .folder + .fold {
          transition: padding ease 250ms;
        }
        #MainFooter nav.footer-nav .folder + .fold > li {
          height: 0;
          overflow: hidden;
          transition: height ease 250ms;
        }
        #MainFooter nav.footer-nav .folder + .fold.sprite {
          transition: padding ease 250ms;
        }
        #MainFooter nav.footer-nav .folder + .fold.sprite > li {
          transition: height ease 250ms, margin ease 250ms;
          margin: 0;
          height: 0;
        }
        #MainFooter nav.footer-nav .folder + .fold.sprite-flags {
          transition: padding ease 250ms;
        }
        #MainFooter nav.footer-nav .folder + .fold.sprite-flags > li {
          height: 0;
          transition: height ease 250ms;
        }
        #MainFooter nav.footer-nav .folder.open {
          padding-bottom: 0;
        }
        #MainFooter nav.footer-nav .folder.open + .fold > li {
          height: 28px;
        }
        #MainFooter nav.footer-nav .folder.open + .fold.sprite > li {
          height: 40px;
          margin: 5px;
        }
        #MainFooter nav.footer-nav .folder.open + .fold.sprite-flags > li {
          height: 30px;
        }
        #MainFooter .legal-navigation {
          padding: 16px 32px;
          margin: 0;
          background: #fff;
        }
        #MainFooter .legal-navigation > li {
          font-family: robotoc, 'Arial Narrow', sans-serif;
          font-size: 12px;
          list-style: none;
          text-align: left;
        ...
        #MainFooter .legal-navigation > li > a {
          color: #999;
        }
