...
import styles from './ProductEditoCard.module.scss';
import useOnScreen from 'utils/useOnScreen';
import useGTM, { TrackEvent } from 'utils/useGTM';

const ProductEditoCard = ({brand, model, pcid, id, url, visuelUrl, statusLabel}) => {
  ...
  const trackGTMCard = (eventName) => {
    ...
    return (
        <a href={url} className={styles.url} ref={trackCard} onClick={
          () => {
...
export default ProductEditoCard;